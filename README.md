<!-- omit in toc -->
# MCP Go 🚀
[![Build](https://github.com/hu-1996/mcp-go/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/hu-1996/mcp-go/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/hu-1996/mcp-go?cache)](https://goreportcard.com/report/github.com/hu-1996/mcp-go)
[![GoDoc](https://pkg.go.dev/badge/github.com/hu-1996/mcp-go.svg)](https://pkg.go.dev/github.com/hu-1996/mcp-go)
...
```bash
go get github.com/hu-1996/mcp-go
```
...
```bash
git clone https://github.com/hu-1996/mcp-go.git
cd mcp-go
```
